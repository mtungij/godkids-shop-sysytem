...
const Congraturation = () => {
    ...
    return (
        <div className="overflow-hidden bg-gray-50 dark:bg-gray-900 h-dvh">
            <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-20">
                <div className="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
                    <div className="text-center">
                        ...
                        <h1 className="text-3xl text-gray-800 font-bold sm:text-4xl lg:text-5xl lg:leading-tight dark:text-neutral-200">
                            Congraturations,{" "}
                        ...
                        <div className="shrink-0 pb-5 sm:flex sm:pb-0 sm:pe-5">
                            <div className="flex justify-center -space-x-3">
                                <span className="inline-flex items-center justify-center size-8 rounded-full ring-2 ring-white bg-gray-800 dark:bg-neutral-900 dark:ring-neutral-900">
                                    <span className="inline-flex justify-center items-center size-[46px] rounded-full border border-yellow-500 text-yellow-500">
                                        <svg
                    ...
                    <div className="text-sm text-center text-balance text-gray-500 dark:text-neutral-500">
                        Mauzodata is the best sales software for your business,
                        we help you to control your business just on you hand
                    ...
                    <div>
                        <div className="mx-auto max-w-2xl sm:flex sm:space-x-3 p-3 bg-white border rounded-lg shadow-lg shadow-gray-100 dark:bg-neutral-900 dark:border-neutral-700 dark:shadow-gray-900/20">
                            <div className="whitespace-nowrap pt-2 sm:pt-0 grid sm:block">
                                <a
                                    className="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-3xl border border-transparent bg-indigo-600 text-white hover:bg-indigo-700 focus:outline-none focus:bg-indigo-700 disabled:opacity-50 disabled:pointer-events-none"
